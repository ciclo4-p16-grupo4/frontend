<template>
	<footer>
		...
		<section class="">
			<h4>Administrando bienes</h4>
			<p>
				Lorem ipsum dolor sit amet consectetur adipiscing magna felis, vestibulum hendrerit morbi.
			</p>
		...
		<section class="">
			...
			<ul>
				<li>
					<a href="/buscar?filter_by=contrato&filter_value=AL">Alquilar</a>
				</li>
				<li>
					<a href="/buscar?filter_by=contrato&filter_value=VE">Comprar</a>
				</li>
				<!-- <li>
					<a href="./buscar?filter_by=contrato&filter_value=AL">Bienes</a>
				</li>
				<li>
					<a href="./buscar?filter_by=contrato&filter_value=AL">Contacto</a>
				</li> -->
			</ul>
		</section>
			...
			<ul>
				<li>
					<div class="list-icon">
						...
						<a href="tel:+57 3120642673">+57 3120642673</a>
					</div>	
				</li>
				<li>
					<div class="list-icon">
						...
						<a href="mailto:cont@admin.com">cont@admin.com</a>
					</div>
				</li>
				<li>
					<div class="list-icon">
						...
						<a 	href="addres:+57 3120642673">4235 Ave, 20-13</a>
					</div>
				</li>
			</ul>
		</section>
	...
	<div class="bottom-footer">
		<h4>Administrando Bienes © Todos los derechos reservados {{new Date().getFullYear()}}</h4>
	</div>
	</footer>
</template>
